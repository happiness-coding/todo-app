...
public class TodoItemPersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindByTitleActive;
	private FinderPath _finderPathWithoutPaginationFindByTitleActive;
	private FinderPath _finderPathCountByTitleActive;
	 ...
	 */
	@Override
	public List<TodoItem> findByTitleActive(String title, boolean isActive) {
		return findByTitleActive(
			title, isActive, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	 ...
	 */
	@Override
	public List<TodoItem> findByTitleActive(
		String title, boolean isActive, int start, int end) {

		return findByTitleActive(title, isActive, start, end, null);
	}
	...
	public List<TodoItem> findByTitleActive(
		...
		return findByTitleActive(
			title, isActive, start, end, orderByComparator, true);
	}
	...
	public List<TodoItem> findByTitleActive(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath = _finderPathWithoutPaginationFindByTitleActive;
				finderArgs = new Object[] {title, isActive};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByTitleActive;
			finderArgs = new Object[] {
		...
		if (list == null) {
			...
			if (title.isEmpty()) {
				sb.append(_FINDER_COLUMN_TITLEACTIVE_TITLE_3);
			}
			else {
				bindTitle = true;

				sb.append(_FINDER_COLUMN_TITLEACTIVE_TITLE_2);
			}

			sb.append(_FINDER_COLUMN_TITLEACTIVE_ISACTIVE_2);
	...
	public TodoItem findByTitleActive_First(
		...
		TodoItem todoItem = fetchByTitleActive_First(
	...
	public TodoItem fetchByTitleActive_First(
		...
		List<TodoItem> list = findByTitleActive(
			title, isActive, 0, 1, orderByComparator);
	...
	public TodoItem findByTitleActive_Last(
		...
		TodoItem todoItem = fetchByTitleActive_Last(
			title, isActive, orderByComparator);
	...
	public TodoItem fetchByTitleActive_Last(
		...
		int count = countByTitleActive(title, isActive);
		...
		List<TodoItem> list = findByTitleActive(
			title, isActive, count - 1, count, orderByComparator);
	...
	public TodoItem[] findByTitleActive_PrevAndNext(
		...
		try {
			...
			array[0] = getByTitleActive_PrevAndNext(
				session, todoItem, title, isActive, orderByComparator, true);

			array[1] = todoItem;

			array[2] = getByTitleActive_PrevAndNext(
				session, todoItem, title, isActive, orderByComparator, false);
	...
	protected TodoItem getByTitleActive_PrevAndNext(
		Session session, TodoItem todoItem, String title, boolean isActive,
		OrderByComparator<TodoItem> orderByComparator, boolean previous) {
	...
	public void removeByTitleActive(String title, boolean isActive) {
		for (TodoItem todoItem :
				findByTitleActive(
					title, isActive, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
					null)) {
	...
	public int countByTitleActive(String title, boolean isActive) {
		...
		FinderPath finderPath = _finderPathCountByTitleActive;

		Object[] finderArgs = new Object[] {title, isActive};
	...
	private static final String _FINDER_COLUMN_TITLEACTIVE_TITLE_2 =
		"todoItem.title = ? AND ";

	private static final String _FINDER_COLUMN_TITLEACTIVE_TITLE_3 =
		"(todoItem.title IS NULL OR todoItem.title = '') AND ";

	private static final String _FINDER_COLUMN_TITLEACTIVE_ISACTIVE_2 =
		"todoItem.isActive = ?";
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByTitleActive = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByTitleActive",
			new String[] {
				String.class.getName(), Boolean.class.getName(),
				Integer.class.getName(), Integer.class.getName(),
				OrderByComparator.class.getName()
			},
			new String[] {"title", "isActive"}, true);

		_finderPathWithoutPaginationFindByTitleActive = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByTitleActive",
			new String[] {String.class.getName(), Boolean.class.getName()},
			new String[] {"title", "isActive"}, true);

		_finderPathCountByTitleActive = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByTitleActive",
			new String[] {String.class.getName(), Boolean.class.getName()},
			new String[] {"title", "isActive"}, false);
